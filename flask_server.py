...
if __name__ == '__main__':
    # Use port 12000 for work-1 or 12001 for work-2
    port = 12000
    print(f"Starting server on port {port}...")
    print(f"Access the Nexus 1.1 download page at: https://work-1-vhgvqpfwcvfdmegs.prod-runtime.all-hands.dev")
    print(f"Direct download link: https://work-1-vhgvqpfwcvfdmegs.prod-runtime.all-hands.dev/download/nexus_1_1.zip")
